...
def print_run_prompts(
    prompt_input: Union[str, List[str]], prompt: str, output: str
) -> None:
    print(f"=== START =======================================================")
    print("~~~ prompt_input    ----------------------------------------------")
    print(prompt_input, "\n")
...
def gpt_request_messages(
    messages: List[dict], model: str = "gpt-4o", max_tokens: int = 1500
) -> str:
    """Make a request to OpenAI's GPT model."""
    if model == "o1-preview":
        try:
