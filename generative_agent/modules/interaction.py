...
def run_gpt_generate_utterance(
    ...
    def create_prompt_input(
        agent_desc: str, str_dialogue: str, context: str
    ) -> List[str]:
    ...
    prompt_lib_file = (
        f"{LLM_PROMPT_DIR}/generative_agent/interaction/utternace/utterance_v1.txt"
    )
...
def utterance(
    agent: "GenerativeAgent", curr_dialogue: List[List[str]], context: str
) -> str:
    ...
    return run_gpt_generate_utterance(agent_desc, str_dialogue, context, "1", LLM_VERS)[
        0
    ]
